...
(function () {
  ...
  var InjectSvg = /*@__PURE__*/(function (Instance) {
    ...
    InjectSvg.prototype.replace = function replace () {
      ...
      this.node.setAttribute('data-design-system-inject-svg', true);
      var svgAttributes = {
        'aria-hidden': true,
        focusable: false
      };
    ...
    InjectSvg.prototype.restore = function restore () {
      if (this.img && this.svg) {
        this.node.setAttribute('data-design-system-inject-svg', false);
...
//# sourceMappingURL=design-system.nomodule.js.map
