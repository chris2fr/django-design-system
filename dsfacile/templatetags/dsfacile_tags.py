...
from dsfacile.utils import (
    find_active_menu_items,
    generate_random_id,
    parse_tag_args,
    dsfacile_input_class_attr,
)
...
@register.inclusion_tag("dsfacile/global_css.html")
...
@register.inclusion_tag("dsfacile/global_js.html", takes_context=True)
...
@register.inclusion_tag("dsfacile/favicon.html")
...
@register.inclusion_tag("dsfacile/theme_modale.html")
...
@register.inclusion_tag("dsfacile/accordion.html")
...
@register.inclusion_tag("dsfacile/accordion_group.html")
...
@register.inclusion_tag("dsfacile/alert.html")
...
@register.inclusion_tag("dsfacile/badge.html")
...
@register.inclusion_tag("dsfacile/badge_group.html")
...
@register.inclusion_tag("dsfacile/breadcrumb.html", takes_context=True)
...
@register.inclusion_tag("dsfacile/button.html")
...
@register.inclusion_tag("dsfacile/button_group.html")
...
@register.inclusion_tag("dsfacile/callout.html")
...
@register.inclusion_tag("dsfacile/card.html")
...
@register.inclusion_tag("dsfacile/consent.html")
...
@register.inclusion_tag("dsfacile/content.html")
def dsfacile_content(*args, **kwargs) -> dict:
    ...
    data_dict = {
        ...
        "transcription": "(Optional) A transcription item dictionary, see [component documentation](/django-dsfacile/components/transcription/)",
    }
    ```
...
@register.inclusion_tag("dsfacile/france_connect.html")
...
@register.inclusion_tag("dsfacile/highlight.html")
def dsfacile_highlight(*args, **kwargs) -> dict:
    ...
    - Color classes ([See the list](/django-dsfacile/resources/colors)), for example `dsfacile-highlight--green-emeraude`
...
@register.inclusion_tag("dsfacile/input.html")
...
@register.inclusion_tag("dsfacile/link.html")
...
@register.inclusion_tag("dsfacile/notice.html")
...
@register.inclusion_tag("dsfacile/pagination.html", takes_context=True)
...
@register.inclusion_tag("dsfacile/quote.html")
...
@register.inclusion_tag("dsfacile/select.html")
...
@register.inclusion_tag("dsfacile/sidemenu.html", takes_context=True)
...
@register.inclusion_tag("dsfacile/skiplinks.html", takes_context=True)
...
@register.inclusion_tag("dsfacile/stepper.html")
...
@register.inclusion_tag("dsfacile/summary.html")
...
@register.inclusion_tag("dsfacile/table.html")
...
@register.inclusion_tag("dsfacile/tag.html")
...
@register.inclusion_tag("dsfacile/tile.html")
...
@register.inclusion_tag("dsfacile/toggle.html")
...
@register.inclusion_tag("dsfacile/tooltip.html")
...
@register.inclusion_tag("dsfacile/transcription.html")
...
@register.inclusion_tag("dsfacile/form_snippet.html", takes_context=True)
...
@register.inclusion_tag("dsfacile/form_field_snippets/field_snippet.html")
...
register.filter(name="dsfacile_input_class_attr", filter_func=dsfacile_input_class_attr)
