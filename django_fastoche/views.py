...
# from django_fastoche.forms import (
#     FastocheAuthorCreateForm,
#     FastocheBookCreateFormSet,
#     FastocheBookCreateFormHelper,
# )
# from django_fastoche.models import FastocheAuthor
from django_fastoche.utils import format_markdown_from_file
        ...
        + [
            (
                "see_all",
                {
                    ...
                    "url": "/django_fastoche/components/",
                },
            )
        ]
    )
...
def components_index(request):
    ...
    return render(request, "django_fastoche/components_index.html", payload)
...
def page_component(request, tag_name):  # NOSONAR
    ...
    if tag_name == "footer":
        ...
        return render(request, "django_fastoche/not_yet.html", payload)
...
def page_component_header(request):
    ...
    return render(request, "django_fastoche/doc_markdown.html", payload)
...
def resource_icons(request):
    ...
    return render(request, "django_fastoche/page_icons.html", payload)
