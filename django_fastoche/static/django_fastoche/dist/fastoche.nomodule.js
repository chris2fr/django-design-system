/*! FASTOCHE v11.2.2 | SPDX-License-Identifier: MIT | License-Filename: LICENSE.md | restricted use (see terms and conditions) */
...
(function () {
  ...
  var InjectSvg = /*@__PURE__*/(function (Instance) {
    ...
    InjectSvg.prototype.replace = function replace () {
      ...
      this.node.setAttribute('data-fastoche-inject-svg', true);
      var svgAttributes = {
        'aria-hidden': true,
        focusable: false
      };
    ...
    InjectSvg.prototype.restore = function restore () {
      if (this.img && this.svg) {
        this.node.setAttribute('data-fastoche-inject-svg', false);
...
//# sourceMappingURL=fastoche.nomodule.js.map
