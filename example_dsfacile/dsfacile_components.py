...
from example_dsfacile.utils import lorem_ipsum

# Sample SVG file
with open("example_dsfacile/static/img/gouvernement.svg") as svg_file:
    ...
    "tile": {
        ...
        "sample_data": [
            ...
            },
            {
                ...
                "svg_path": static("dsfacile/dist/artwork/pictograms/map/map.svg"),
            },
            {
            ...
            },
            {
                ...
                "url": "/",
                "svg_path": static(
                    "dsfacile/dist/artwork/pictograms/document/document-signature.svg"
                ),
            },
        ],
...
NOT_YET_IMPLEMENTED_COMPONENTS = {
    "radio_rich": {
        ...
        cf. [#126](https://github.com/numerique-gouv/django-dsfacile/issues/126)
        """,
    },
    "segmented_control": {
        ...
        "note": """À implémenter au sein des formulaires et non comme une balise.
        cf. [#128](https://github.com/numerique-gouv/django-dsfacile/issues/128)
        """,
    },
    "range": {
        "title": "Curseur",
        ...
        "note": """À implémenter au sein des formulaires et non comme une balise.
        cf. [#129](https://github.com/numerique-gouv/django-dsfacile/issues/129)
        """,
    },
}

# There is no need for specific tags for these
# (either because the dsfacile is implemented globally or because they are
...
WONT_BE_IMPLEMENTED = {
    "back_to_top": {
        ...
        "reason": "Utilisez une balise Lien (`dsfacile_link`)",
    },
    "checkbox": {
        "title": "Case à cocher",
    ...
    "download": {
        ...
        "reason": "Pas un composant mais une série de variantes d’autres composants : [lien](/django-dsfacile/components/link/), [carte](/django-dsfacile/components/card/), [tuile](/django-dsfacile/components/tile/). Voir la documentation de ceux-ci.",
    },
    "file_upload": {
