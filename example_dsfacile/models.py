...
class DsfacileAuthor(models.Model):
    ...
    class Meta:
        verbose_name = _("DSFacile DsfacileAuthor")


class DsfacileGenre(models.Model):
    ...
    class Meta:
        verbose_name = _("DSFacile DsfacileGenre")
...
class DsfacileBook(models.Model):
    author = models.ForeignKey(
        DsfacileAuthor, on_delete=models.CASCADE, null=False, blank=False
    )
    ...
    genre = models.ManyToManyField(DsfacileGenre)

    class Meta:
        verbose_name = _("DSFacile DsfacileBook")
