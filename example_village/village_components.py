...
from example_village.utils import lorem_ipsum

# Sample SVG file
with open("example_village/static/img/gouvernement.svg") as svg_file:
    ...
    "tile": {
        ...
        "sample_data": [
            ...
            },
            {
                ...
                "svg_path": static(
                    "django_village/dist/artwork/pictograms/leisure/paint.svg"
                ),
            },
            {
