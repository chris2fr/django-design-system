...
IMPLEMENTED_COMPONENTS = {
    ...
    "link": {
        ...
        "sample_data": [
            {
                "url": "/django_fastoche/components/link/",
                "label": "Lien interne",
            },
            {
                "url": "https://www.systeme-de-design.gouv.fr/",
                        ...
                        "items": [
                            ...
                            },
                            {
                                ...
                                "items": [
                                    ...
                                    {
                                        "label": "Page active",
                                        "link": "/django_fastoche/components/sidemenu/",
                                    },
                                ],
                            },
                        ],
    ...
    "tag": {
        ...
        "sample_data": [
            {"label": "Tag simple"},
            {"label": "Tag avec lien", "link": "/django_fastoche/components"},
            {
    ...
    "tile": {
        ...
        "sample_data": [
            ...
            },
            {
                ...
                "svg_path": static(
                    "django_fastoche/dist/artwork/pictograms/buildings/city-hall.svg"
                ),
            },
            {
                ...
                "svg_path": static(
                    "django_fastoche/dist/artwork/pictograms/buildings/nuclear-plant.svg"
                ),
            },
            {
                ...
                "svg_path": static("django_fastoche/dist/artwork/pictograms/map/map.svg"),
            },
            {
                ...
                "svg_path": static(
                    "django_fastoche/dist/artwork/pictograms/leisure/paint.svg"
                ),
            },
            {
                ...
                "url": "/",
                "svg_path": static(
                    "django_fastoche/dist/artwork/pictograms/document/document-signature.svg"
                ),
            },
        ],
...
NOT_YET_IMPLEMENTED_COMPONENTS = {
    "radio_rich": {
        ...
        cf. [#126](https://github.com/numerique-gouv/django_fastoche/issues/126)
        """,
    },
    "segmented_control": {
        ...
        "note": """À implémenter au sein des formulaires et non comme une balise.
        cf. [#128](https://github.com/numerique-gouv/django_fastoche/issues/128)
        """,
    },
    "range": {
        "title": "Curseur",
        ...
        "note": """À implémenter au sein des formulaires et non comme une balise.
        cf. [#129](https://github.com/numerique-gouv/django_fastoche/issues/129)
        """,
    },
}
...
WONT_BE_IMPLEMENTED = {
    ...
    "download": {
        ...
        "reason": "Pas un composant mais une série de variantes d’autres composants : [lien](/django_fastoche/components/link/), [carte](/django_fastoche/components/card/), [tuile](/django_fastoche/components/tile/). Voir la documentation de ceux-ci.",
    },
    "file_upload": {
