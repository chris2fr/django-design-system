...
- <a class="cfran-link cfran-icon-external-link-line cfran-link--icon-right cfran-link--lg" href="https://www.systeme-de-design.gouv.fr/elements-d-interface/composants/en-tete" target="_blank" rel="noopener noreferrer">
...
- <a class="cfran-link cfran-icon-external-link-line cfran-link--icon-right cfran-link--lg" href="https://main--ds-gouv.netlify.app/example/component/header/" target="_blank" rel="noopener noreferrer">
    ...
    <div class="cfran-container cfran-container-lg--fluid">
      ...
      <form action="{% url 'page_search' %}" method="get">
        <div class="cfran-search-bar" id="search-bar" role="search">
          <label class="cfran-label" for="search-bar-input">
            Rechercher
          </label>
          <input class="cfran-input"
                 ...
                 id="query"
                 name="q">
          <button class="cfran-btn" title="Rechercher">
            Rechercher
          </button>
        </div>
      </form>
