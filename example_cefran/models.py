...
class CefranAuthor(models.Model):
    ...
    class Meta:
        verbose_name = _("cefran CefranAuthor")


class CefranGenre(models.Model):
    ...
    class Meta:
        verbose_name = _("cefran CefranGenre")
...
class CefranBook(models.Model):
    author = models.ForeignKey(
        CefranAuthor, on_delete=models.CASCADE, null=False, blank=False
    )
    ...
    genre = models.ManyToManyField(CefranGenre)

    class Meta:
        verbose_name = _("cefran CefranBook")
