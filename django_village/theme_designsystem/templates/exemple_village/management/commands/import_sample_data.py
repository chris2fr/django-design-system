...
from design_system.models import DjangoDesignSystemConfig, DesignSystemSocialMedia
    ...
    def handle(self, *args, **options):
        ...
        config, _created = DjangoDesignSystemConfig.objects.get_or_create(
            ...
            defaults={
                ...
                "newsletter_url": "https://github.com/numerique-gouv/django_design_system/releases",
            },
        )
