/*! CEFRAN v0.0.1 | SPDX-License-Identifier: MIT | License-Filename: LICENSE.md | restricted use (see terms and conditions) */
...
(function () {
  ...
  var InjectSvg = /*@__PURE__*/(function (Instance) {
    ...
    InjectSvg.prototype.replace = function replace () {
      ...
      this.node.setAttribute('data-cefran-inject-svg', true);
      var svgAttributes = {
        'aria-hidden': true,
        focusable: false
      };
    ...
    InjectSvg.prototype.restore = function restore () {
      if (this.img && this.svg) {
        this.node.setAttribute('data-cefran-inject-svg', false);
...
//# sourceMappingURL=cefran.nomodule.js.map
