# Contribuer à Django-Design-System
...
- mettre à jour le fichier README.rst pour indiquer la nouvelle version du DESIGN_SYSTEM ;
...
De la même manière, lorsqu’une PR est mergée dans la branche `main`, une tâche Github Actions ([deploy-doc.yml]([./.github/workflows/deploy-doc.yml)) met à jour la [documentation statique](https://numerique-gouv.github.io/django-design-system/) en faisant un export statique du site d’exemple.
